...
], function(BaseController, MessageBox, ActionSheet7, Utilities, History) {
	"use strict";

	return BaseController.extend("com.sap.build.standard.sistemaDeArchivos.controller.Page2", {
