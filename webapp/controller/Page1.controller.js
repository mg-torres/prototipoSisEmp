sap.ui.define(["sap/ui/core/mvc/Controller",
	"sap/m/MessageBox",
	"./ActionSheet1", "./ActionSheet3", "./ActionSheet2",
	"./utilities",
	"sap/ui/core/routing/History"
], function(BaseController, MessageBox, ActionSheet1, ActionSheet3, ActionSheet2, Utilities, History) {
	"use strict";

	return BaseController.extend("com.sap.build.standard.sistemaDeArchivos.controller.Page1", {
		...
		_onIconPress1: function(oEvent) {
			...
			var sActionsheetName = "ActionSheet3";
			this.mActionsheets = this.mActionsheets || {};
			var oActionsheet = this.mActionsheets[sActionsheetName];

			if (!oActionsheet) {
				oActionsheet = new ActionSheet3(this.getView());
				this.mActionsheets[sActionsheetName] = oActionsheet;
		...
		_onButtonPress: function(oEvent) {
			...
			var sActionsheetName = "ActionSheet1";
			this.mActionsheets = this.mActionsheets || {};
			var oActionsheet = this.mActionsheets[sActionsheetName];

			if (!oActionsheet) {
				oActionsheet = new ActionSheet1(this.getView());
				this.mActionsheets[sActionsheetName] = oActionsheet;
